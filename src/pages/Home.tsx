  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <header className="bg-white px-5 pt-12 pb-4 flex items-start justify-between">
        ...
        <button className="w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center mt-1">
      ...
      <div className="flex-1 px-4 pt-4 flex flex-col gap-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          {/* Sessions */}
          <div className="bg-white rounded-2xl p-4 border border-[#f0f0f0] flex flex-col items-center gap-0.5">
        ...
        {currentWorkout ? (
          <Link to="/workout/current" className="block">
            <div className="w-full bg-amber-500 rounded-2xl px-5 py-[18px] flex items-center gap-4 active:opacity-90 active:scale-[0.99] transition-transform">
          ...
          <button
            onClick={onStart}
            className="w-full bg-tint rounded-2xl px-5 py-[18px] flex items-center gap-4 active:opacity-90 active:scale-[0.99] transition-transform text-left shadow-[0_4px_20px_rgba(16,185,129,0.3)]"
          >
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              {recent.map((workout) => {
                ...
                return (
                  <Link key={workout.id} to={`/workout/${workout.id}`} className="block">
